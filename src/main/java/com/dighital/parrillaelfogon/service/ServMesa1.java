...
public class ServMesa1 {
    ...
    public Optional<Mesas1> getByEstado(String estado){
        return rMesas1.findByEstado(estado);
    }
    ...
    public boolean existByEstado(String estado){
        return rMesas1.existsByEstado(estado);
    }
}
